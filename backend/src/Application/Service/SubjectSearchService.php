...
SQL;
        ...
        $content = array_map(function ($file) {
            return [
                ...
                'original_date_time' => $file->getOriginalDateTime()?->format('Y-m-d H:i:s'),
                'rights_holder' => $file->getRightsHolder(),
                'rights_terms' => $file->getRightsTerms(),
                'rights_url' => $file->getRightsUrl(),
                'creator_name' => $file->getCreatorName(),
                'creator_email' => $file->getCreatorEmail(),
                'creator_country' => $file->getCreatorCountry(),
                'creator_url' => $file->getCreatorUrl(),
                'location_id' => $file->getLocationId(),
                'width' => $file->getWidth(),
